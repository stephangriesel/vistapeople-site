        ...
        collections: [
          {
            ...
            delete: true,
            fields: [
              { name: "title", widget: "string", label: "Headline", required: true },
              {
                name: "description",
                widget: "string",
                label: "Description",
              ...
              },
              {
                ...
                field: {
                  ...
                  widget: "image",
                  label: "Photo",
                  media_folder: "/public/assets/hero/faces",
                  public_folder: "/assets/hero/faces",
                },
              },
              {
                name: "layout",
          ...
          },
          {
            ...
            delete: true,
            fields: [
              { name: "title", widget: "string", label: "Heading", default: "About us" },
              {
                name: "description1",
                widget: "string",
                label: "Paragraph 1",
          ...
          },
          {
            ...
            delete: true,
            fields: [
              { name: "title", widget: "string", label: "Heading", default: "Services" },
              {
                name: "block1title",
                widget: "string",
